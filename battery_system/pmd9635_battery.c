...
if (b9635data->alarm_wakeup_proc != 0) b9635data->alarm_wakeup_proc(b9635data->bat);
}
...
if (b9635data->timer_resume_proc != 0) b9635data->timer_resume_proc(b9635data->bat);
return 0;
}
...
if (b9635data->timer_suspend_proc != 0) b9635data->timer_suspend_proc(b9635data->bat);
...
if (b9635data->x_timer_suspend_proc != 0) ret=b9635data->x_timer_suspend_proc(b9635data->bat,&var1);
